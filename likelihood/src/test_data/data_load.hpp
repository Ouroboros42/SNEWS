...
struct TestSignal : public TimeSeries {
    ...
    /* Load a test signal and extend the time range by front_buffer past first event and end_buffer past last event */
    TestSignal(Detector detector, std::string file_id, scalar front_buffer, scalar end_buffer);
